...
public class RenderBeaconCart extends RenderMinecart<EntityBeaconCart> {
	public RenderBeaconCart(RenderManager renderManagerIn) {
		super(renderManagerIn);
	}
	
	@Override
	public void doRender(EntityBeaconCart entity, double x, double y, double z, float entityYaw, float partialTicks) {
		super.doRender(entity, x, y, z, entityYaw, partialTicks);
		//AxisAlignedBB bbox = entity.getRenderBoundingBox();
		this.renderBeacon(x - 0.5, y, z - 0.5, (double) partialTicks, (double) entity.shouldBeamRender(), entity.getBeamSegments(),
				(double) entity.world.getTotalWorldTime());
	}
	...
	public void renderBeacon(double x, double y, double z, double partialTicks, double textureScale,
		...
		//if (totalWorldTime % 20 == 0) System.out.println("shouldBeaconRender: "+textureScale);
